      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center flex-wrap gap-y-4">
            ...
            <div className="flex items-center flex-wrap justify-end gap-x-4 sm:gap-x-6 gap-y-2">
              <button onClick={() => navigate('/leaderboard')} className="flex items-center space-x-2 text-gray-600 font-medium hover:text-blue-600 transition-colors text-sm">
                <Award className="w-5 h-5" />
                <span>Peringkat</span>
              </button>
              <button onClick={() => navigate('/history')} className="flex items-center space-x-2 text-gray-600 font-medium hover:text-blue-600 transition-colors text-sm">
              ...
              <button onClick={onLogout} className="flex items-center space-x-2 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm">
